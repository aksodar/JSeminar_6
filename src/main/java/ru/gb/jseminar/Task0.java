...
public class Task0 {
    ...
    public void initHashSet(){
        Set<Integer> set = new HashSet<>(Arrays.asList(1, 3, 2, 2, 4, 5, 6, 3));
    ...
    public void initLinkedHashSet(){
        Set<Integer> set = new LinkedHashSet<>(Arrays.asList(1, 3, 2, 2, 4, 5, 6, 3)); 
        System.out.println(set);
    ...
    public void initTreeSet(){
        Set<Integer> set = new TreeSet<>(Arrays.asList(1, 3, 2, 2, 4, 5, 6, 3));
        System.out.println(set); 
